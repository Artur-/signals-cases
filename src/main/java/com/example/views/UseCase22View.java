...
/**
 * Use Case 22: Responsive Layout with Window Size Signal
 *
...
@PageTitle("Use Case 22: Responsive Layout")
@Menu(order = 30, title = "UC 22: Responsive Layout")
@PermitAll
public class UseCase22View extends VerticalLayout {
    ...
    public UseCase22View() {
        ...
        H2 title = new H2("Use Case 22: Responsive Layout with Window Size Signal");
