...
/**
 * Use Case 18: Responsive Layout with Window Size Signal
 *
...
@PageTitle("Use Case 18: Responsive Layout")
@Menu(order = 30, title = "UC 18: Responsive Layout")
@PermitAll
public class UseCase18View extends VerticalLayout {
    ...
    public UseCase18View() {
        setSpacing(true);
        setPadding(true);

        H2 title = new H2("Use Case 18: Responsive Layout with Window Size Signal");
